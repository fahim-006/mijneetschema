...
class ProductDetail extends Component {
    ...
    componentDidUpdate(prevProps, prevState) {
        if (prevProps.single_product !== this.props.single_product && this.props.get_success) {
            this.setState({like_products:this.props.like_products,loader:false},function(){
                this.likeProduct();
            })
        ...
        if(
            ...
            (this.props.match.params.id !== this.props.single_product._id)
        ){
            this.props.listSingleProduct({product_id: this.props.match.params.id });
                  ...
                  <div className="wow fadeInUp item" key={product._id}>
                      <div className="team_membar carousel_team_blk">
                          <div className="diet_item prod-con">
                              <ProductCard {...product} handleAddWish={this.handleAddWish} handleAddToCart={this.handleAddToCart}/>
                          </div>
                      </div>
                  </div>
              )
            ...
            <ProductsLayout>
                        ...
                        <div className="col-12">
                            <div className="steps_result">
                                <div className="banner_txt d-flex">
                                    <div className="banr_headng">product <br />detail</div>
                ...
                <div className="content-area homepage-content-main">
                   ...
                   {loader?
                    ...
                    Object.keys(this.props.single_product).length>0 ?
                        ...
                        <div className="container">
                            <div className="row">
                                <div className="col-md-12">
                                    <h2 className="sec-heading text-center">You may <span className="black-txt">also like</span></h2>
                                </div>
                            </div>
